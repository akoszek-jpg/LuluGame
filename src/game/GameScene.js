...
const SPECIAL_VOICE_LINES = {
    trashOut: "Wynieś śmieci!",
    foch: "Fohc!"
};
const SPECIAL_VOICE_CONFIG = {
...
export class GameScene extends Phaser.Scene {
    constructor(hudUpdater, overlayUpdater, inputState) {
        super("game-scene");
        Object.defineProperty(this, "hudUpdater", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "overlayUpdater", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "controlMode", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: "classic"
        ...
        Object.defineProperty(this, "timeLeft", {
            ...
            configurable: true,
            writable: true,
            value: BASE_LEVEL_TIME
        });
        Object.defineProperty(this, "message", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: "Sprzątaj szybciej, niż AREK bałagani."
        });
        ...
        Object.defineProperty(this, "roomLayer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "roomTexts", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "furnitureStates", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "playerView", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "arekView", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "playerTarget", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "arekPosition", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Phaser.Math.Vector2()
        });
        Object.defineProperty(this, "arekTarget", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Phaser.Math.Vector2()
        });
        Object.defineProperty(this, "arekTargetFurniture", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "cleaningFurniture", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "cleaningRemaining", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "arekDirtyFurniture", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "arekDirtyRemaining", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "trashOutPhase", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "trashOutHiddenRemaining", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "arekHidden", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "nextLevelTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "fullCleanPending", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "lastAllCleanState", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "lastVoiceAt", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "overlayVisible", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "pendingLevelIndex", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "pendingRestart", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "avatarVariant", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 1
        ...
        Object.defineProperty(this, "musicStep", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "audioQueueToken", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "cleaningOscillator", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "cleaningGain", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    preload() {
        this.load.image("character-luiza-photo", `${import.meta.env.BASE_URL}assets/luiza.png`);
        this.load.image("character-arek-photo", `${import.meta.env.BASE_URL}assets/arek.jpg`);
    }
    create() {
    ...
    loadLevel(index, resetScore) {
        ...
        this.playerPosition.set(this.currentLevel.playerSpawn.x, this.currentLevel.playerSpawn.y);
        this.arekPosition.set(this.currentLevel.arekSpawn.x, this.currentLevel.arekSpawn.y);
    ...
    drawLevel() {
        ...
        graphics.strokeRoundedRect(8, 8, this.currentLevel.width - 16, this.currentLevel.height - 16, 32);
        ...
        graphics.fillRoundedRect(this.currentLevel.door.x - 26, this.currentLevel.door.y - 12, 54, 24, 8);
        ...
        this.currentLevel.furniture.forEach((item, index) => {
            ...
            const shadow = this.add.ellipse(item.x, item.y + item.height * 0.22, item.width * 0.78, 18, 0x6e4939, 0.22);
            const aura = this.add.ellipse(item.x, item.y + item.height * 0.06, item.width * 0.94, Math.max(24, item.height * 0.58), 0xc56a4a, 0.18);
            ...
            const dirt = this.add.image(item.x + item.width * dirtStyle.offsetX, item.y + item.height * dirtStyle.offsetY, dirtStyle.textureKey);
            dirt.setScale(Math.max(0.36, Math.min(item.width, item.height) / 124) * dirtStyle.scale);
            dirt.setAngle(dirtStyle.angle);
            dirt.setAlpha(0.98);
            const sparkle = this.add.image(item.x + item.width * 0.28, item.y - item.height * 0.28, "fx-sparkle");
    ...
    createCharacter(texture, labelText, labelColor) {
        ...
        const aura = this.add.ellipse(position.x, position.y + 2, texture === "luiza" ? 40 : 38, texture === "luiza" ? 54 : 50, texture === "luiza" ? 0xff7fb2 : 0x64b8ff, 0.22);
    ...
    readPointerMovement() {
        ...
        const move = new Phaser.Math.Vector2(this.playerTarget.x - this.playerPosition.x, this.playerTarget.y - this.playerPosition.y);
    ...
    updateArek(delta) {
        ...
        if (this.activeAbility?.name === "trashOut") {
            ...
            if (!this.arekHidden) {
                const distanceToDoor = Phaser.Math.Distance.Between(this.arekPosition.x, this.arekPosition.y, this.currentLevel.door.x, this.currentLevel.door.y);
                ...
                this.moveArekTowards(this.currentLevel.door.x, this.currentLevel.door.y, delta, this.getArekMoveSpeed() * TRASH_OUT_MOVE_SPEED_MULTIPLIER);
            }
            this.updateCharacterViews();
            return;
        }
        ...
        if (cleanFurniture.length > 0) {
            ...
            if (Phaser.Math.Distance.Between(this.arekPosition.x, this.arekPosition.y, target.data.x, target.data.y) < 36) {
                this.startArekDirtying(target);
            }
        }
        else {
            this.arekTargetFurniture = undefined;
            if (Phaser.Math.Distance.Between(this.arekPosition.x, this.arekPosition.y, this.arekTarget.x, this.arekTarget.y) < 20) {
                const randomRoom = Phaser.Utils.Array.GetRandom(this.currentLevel.rooms);
                this.arekTarget.set(Phaser.Math.Between(randomRoom.x + 60, randomRoom.x + randomRoom.width - 60), Phaser.Math.Between(randomRoom.y + 60, randomRoom.y + randomRoom.height - 60));
            }
            this.moveArekTowards(this.arekTarget.x, this.arekTarget.y, delta);
        }
        this.updateCharacterViews();
    }
    moveArekTowards(x, y, delta, speedOverride) {
    ...
    findNearbyDirtyFurniture() {
        return this.furnitureStates.find((item) => {
            if (item.state !== "dirty") {
                return false;
            }
            return (Phaser.Math.Distance.Between(this.playerPosition.x, this.playerPosition.y, item.data.x, item.data.y) <= CLEAN_RANGE);
        });
    }
    ...
    finishCleaning(target) {
        ...
        this.score += 10;
        this.message = Phaser.Utils.Array.GetRandom(CLEAN_STATUS_LINES).replace("{label}", target.data.label);
        this.playCleanVoiceLine();
    }
    makeFurnitureDirty(target) {
        ...
        this.message = Phaser.Utils.Array.GetRandom(AREK_MESS_LINES).replace("{label}", target.data.label);
        this.playArekVoiceLine();
    }
    startArekDirtying(target) {
        if (target.state !== "clean") {
            return;
        }
    ...
    resolveArekTarget(cleanFurniture) {
        if (this.arekTargetFurniture &&
    ...
    chooseArekTarget(cleanFurniture) {
        const byArek = [...cleanFurniture].sort((a, b) => {
            const distanceA = Phaser.Math.Distance.Between(this.arekPosition.x, this.arekPosition.y, a.data.x, a.data.y);
            const distanceB = Phaser.Math.Distance.Between(this.arekPosition.x, this.arekPosition.y, b.data.x, b.data.y);
        ...
        const byLuiza = [...cleanFurniture].sort((a, b) => {
            const distanceA = Phaser.Math.Distance.Between(this.playerPosition.x, this.playerPosition.y, a.data.x, a.data.y);
            const distanceB = Phaser.Math.Distance.Between(this.playerPosition.x, this.playerPosition.y, b.data.x, b.data.y);
            return distanceA - distanceB;
        });
    ...
    updateCharacterViews() {
        if (this.playerView) {
            const bob = this.cleaningRemaining > 0
        ...
        if (this.arekView) {
            const bob = this.arekDirtyRemaining > 0
            ...
            this.arekView.sprite.setRotation(this.arekDirtyRemaining > 0
                ? Math.sin(this.time.now / 55) * 0.1
                : this.activeAbility?.name === "foch"
                    ? -0.06
                    : 0);
        }
        this.cameras.main.centerOn(this.currentLevel.width / 2, this.currentLevel.height / 2);
    }
    animateCleaning() {
        if (!this.playerView) {
            return;
    ...
    showLevelCompleteOverlay() {
        ...
        this.overlayUpdater({
            ...
            buttonLabel: this.pendingLevelIndex === null ? "Zobacz wynik" : `Wejdź na poziom ${this.levelIndex + 2}`,
            avatar: "luiza"
        });
    }
    finishGame(victory) {
    ...
    syncHud() {
        this.hudUpdater({
            ...
            trashOutReady: this.gameStarted &&
                !this.gameEnded &&
                !this.overlayVisible &&
                this.abilityCooldowns.trashOut <= 0 &&
                this.activeAbility === null,
            fochReady: this.gameStarted &&
                !this.gameEnded &&
                !this.overlayVisible &&
                this.abilityCooldowns.foch <= 0 &&
                this.activeAbility === null,
    ...
    speakQueuedLine(text, voiceKind, options, token) {
        if (!this.audioEnabled ||
    ...
    getPreferredFemaleVoice() {
        ...
        return (voices.find((voice) => voice.name.toLowerCase() === "microsoft paulina - polish (poland)") ??
    ...
    getPreferredMaleVoice() {
        ...
        const voices = window.speechSynthesis.getVoices();
        return (voices.find((voice) => voice.name.toLowerCase() === "microsoft adam - polish (poland)") ??
            voices.find((voice) => voice.name.toLowerCase().includes("adam")) ??
            voices.find((voice) => voice.lang.toLowerCase().startsWith("pl")));
    }
    playPingQueued(token) {
        if (!this.audioEnabled || token !== this.audioQueueToken) {
            return Promise.resolve();
        }
        return this.playToneQueued(token, (context, startAt) => {
    ...
    playToneQueued(token, play, durationMs) {
        const context = this.getWebAudioContext();
    ...
    drawRoomDecor(graphics, room) {
        ...
        if (room.id === "living" || room.id === "bedroom" || room.id === "kids") {
            for (let x = room.x + 18; x < room.x + room.width - 18; x += 24) {
                graphics.strokeLineShape(new Phaser.Geom.Line(x, room.y + 52, x + 10, room.y + room.height - 18));
            }
            graphics.fillStyle(0xffffff, 0.13);
            graphics.fillRoundedRect(room.x + room.width * 0.22, room.y + room.height * 0.55, room.width * 0.36, room.height * 0.18, 18);
            return;
        }
        if (room.id === "hall" || room.id === "study" || room.id === "office") {
            for (let y = room.y + 54; y < room.y + room.height - 16; y += 20) {
                graphics.strokeLineShape(new Phaser.Geom.Line(room.x + 18, y, room.x + room.width - 18, y));
            }
            return;
        }
        if (room.id === "dining" || room.id === "closet") {
            graphics.fillStyle(0xffffff, 0.1);
            graphics.fillRoundedRect(room.x + room.width * 0.18, room.y + room.height * 0.22, room.width * 0.52, room.height * 0.24, 20);
    ...
    fitCameraToLevel() {
        ...
        const zoom = Math.min(viewportWidth / this.currentLevel.width, viewportHeight / this.currentLevel.height);
    ...
    stopCleaningSound() {
        ...
        this.cleaningGain.gain.setValueAtTime(Math.max(0.0001, this.cleaningGain.gain.value), context.currentTime);
    ...
    playCleanVoiceLine() {
        ...
        this.enqueueAudioAction((token) => this.speakQueuedLine(Phaser.Utils.Array.GetRandom(CLEAN_VOICE_LINES), "female", CLEAN_VOICE_CONFIG, token));
    }
    playSpecialAbilityVoice(name) {
        if (!this.audioEnabled) {
            return;
        }
        this.enqueueAudioAction((token) => this.playPingQueued(token));
        this.enqueueAudioAction((token) => this.speakQueuedLine(SPECIAL_VOICE_LINES[name], "female", SPECIAL_VOICE_CONFIG[name], token));
    ...
    playArekVoiceLine() {
        ...
        this.enqueueAudioAction((token) => this.speakQueuedLine(Phaser.Utils.Array.GetRandom(AREK_VOICE_LINES), "male", AREK_VOICE_CONFIG, token));
    }
    stopVoiceLine() {
        if (typeof window === "undefined" || !("speechSynthesis" in window)) {
            return;
    ...
    resolveFurnitureSprite(id) {
        ...
        if (id.includes("tv"))
            return "tv";
        if (id.includes("washing"))
            return "washing";
        if (id.includes("basket"))
            return "basket";
        ...
        if (id.includes("shelf"))
            return "shelf";
        if (id.includes("toybox"))
            return "toybox";
        if (id.includes("chair"))
            return "chair";
        if (id.includes("lamp"))
            return "lamp";
        if (id.includes("wardrobe"))
            return "wardrobe";
        return "table";
    }
    resolveDirtStyle(id, index) {
        const variants = [
    ...
    createProceduralTextures() {
        ...
        const generate = (key, width, height, draw) => {
            graphics.clear();
            draw();
    ...
    generateFurnitureTexture(generate, key, width, height, draw) {
        generate(key, width, height, draw);
    }
    createFallbackTextures() {
        const graphics = this.make.graphics(undefined, false);
        const fallback = (key, width, height, color) => {
